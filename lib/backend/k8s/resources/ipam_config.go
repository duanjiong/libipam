...
const (
	...
	IPAMConfigCRDName      = "ipamconfigs.network.kubesphere.io"
)
...
func NewIPAMConfigClient(c *kubernetes.Clientset, r *rest.RESTClient) K8sResourceClient {
	return &ipamConfigClient{
		rc: customK8sResourceClient{
			...
			k8sResourceType: reflect.TypeOf(v1alpha1.IPAMConfig{}),
			k8sResourceTypeMeta: metav1.TypeMeta{
				Kind:       v1alpha1.KindIPAMConfig,
				APIVersion: v1alpha1.GroupVersionCurrent,
			},
			k8sListType:  reflect.TypeOf(v1alpha1.IPAMConfigList{}),
			resourceKind: v1alpha1.KindIPAMConfig}}
}
...
func (c ipamConfigClient) toV1(kvpv3 *model.KVPair) (*model.KVPair, error) {
	v3obj := kvpv3.Value.(*v1alpha1.IPAMConfig)
	return &model.KVPair{
		...
		UID:      &kvpv3.Value.(*v1alpha1.IPAMConfig).UID,
	}, nil
}
