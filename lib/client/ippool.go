...
import (
	...
	apiv1alpha1 "kubesphere.io/libipam/lib/apis/v1alpha1"
	"kubesphere.io/libipam/lib/backend/model"
)

// IPPoolInterface has methods to work with IPPool resources.
type IPPoolInterface interface {
	Create(ctx context.Context, res *apiv1alpha1.IPPool, opts options.SetOptions) (*apiv1alpha1.IPPool, error)
	Update(ctx context.Context, res *apiv1alpha1.IPPool, opts options.SetOptions) (*apiv1alpha1.IPPool, error)
	Delete(ctx context.Context, name string, opts options.DeleteOptions) (*apiv1alpha1.IPPool, error)
	Get(ctx context.Context, name string, opts options.GetOptions) (*apiv1alpha1.IPPool, error)
	List(ctx context.Context, opts options.ListOptions) (*apiv1alpha1.IPPoolList, error)
...
func (r ipPools) Create(ctx context.Context, res *apiv1alpha1.IPPool, opts options.SetOptions) (*apiv1alpha1.IPPool, error) {
	if res != nil {
	...
	out, err := r.client.resources.Create(ctx, opts, apiv1alpha1.KindIPPool, res)
	if out != nil {
		return out.(*apiv1alpha1.IPPool), err
	}
	return nil, err
...
// representation of the IPPool, and an error, if there is any.
func (r ipPools) Update(ctx context.Context, res *apiv1alpha1.IPPool, opts options.SetOptions) (*apiv1alpha1.IPPool, error) {
	if res != nil {
		// Since we're about to default some fields, take a (shallow) copy of the input data
		// before we do so.
		resCopy := *res
	...
	out, err := r.client.resources.Update(ctx, opts, apiv1alpha1.KindIPPool, res)
	if out != nil {
		return out.(*apiv1alpha1.IPPool), err
	}
	return nil, err
...
func (r ipPools) Delete(ctx context.Context, name string, opts options.DeleteOptions) (*apiv1alpha1.IPPool, error) {
	...
	out, err := r.client.resources.Delete(ctx, opts, apiv1alpha1.KindIPPool, noNamespace, name)
	if out != nil {
		return out.(*apiv1alpha1.IPPool), err
	}
	return nil, err
...
func (r ipPools) Get(ctx context.Context, name string, opts options.GetOptions) (*apiv1alpha1.IPPool, error) {
	out, err := r.client.resources.Get(ctx, opts, apiv1alpha1.KindIPPool, noNamespace, name)
	if out != nil {
		convertIpPoolFromStorage(out.(*apiv1alpha1.IPPool))
		return out.(*apiv1alpha1.IPPool), err
	}
...
func (r ipPools) List(ctx context.Context, opts options.ListOptions) (*apiv1alpha1.IPPoolList, error) {
	res := &apiv1alpha1.IPPoolList{}
	if err := r.client.resources.List(ctx, opts, apiv1alpha1.KindIPPool, apiv1alpha1.KindIPPoolList, res); err != nil {
		return nil, err
	}
...
func convertIpPoolFromStorage(pool *apiv1alpha1.IPPool) error {
...
func (r ipPools) Watch(ctx context.Context, opts options.ListOptions) (watch.Interface, error) {
	return r.client.resources.Watch(ctx, opts, apiv1alpha1.KindIPPool, nil)
}
...
func (r ipPools) validateAndSetDefaults(ctx context.Context, new, old *apiv1alpha1.IPPool) error {
