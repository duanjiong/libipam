...
func newBlock(id uint32, cidr cnet.IPNet, rsvdAttr *HostReservedAttr) allocationBlock {
...
func getBlockCIDRForAddress(addr cnet.IP, pool *v1alpha1.IPPool) cnet.IPNet {
	var mask net.IPMask
	if addr.Version() == 6 {
...
func largerThanOrEqualToBlock(blockCIDR cnet.IPNet, pool *v1alpha1.IPPool) bool {
